...
class VESC_USB:
    ...
    # def get_controller_imu_list(self):
    #     self.roll_data = [[np.nan, np.nan]]*len(self.controller_imu_list)
    #     self.pitch_data = [[np.nan, np.nan]]*len(self.controller_imu_list)
    #     self.yaw_data = [[np.nan, np.nan]]*len(self.controller_imu_list)
    #     return self.controller_imu_list
