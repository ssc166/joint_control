...
def Cal_Roll_SS(z):
    ...
    param = {w:flywheel_ang_vel, I_fx:0.005950, I_fy:0.011299999, I_bx:3.089539709502296,  m_all:25.278, r:0.069, l: z,  g:9.81, R:0.33, K_t: 0.88, K_e: 0.88, J_m:8e-5, n: 6, f:0}
